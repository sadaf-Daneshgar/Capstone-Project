...
# 📖 [First-Capstone-Project] <a name="about-project"></a>
   **[Capstone-Project]** is a my first module project that show my knowledge in HTML, CSS and  basic knowledge of JavaScript.
...
- By clicking in this link you can see my project [Project link](https://sadaf-daneshgar.github.io/Capstone-Project/)
...
```sh
  cd my-folder
  git clone https://github.com/sadaf-Daneshgar/Capstone-Project.git
